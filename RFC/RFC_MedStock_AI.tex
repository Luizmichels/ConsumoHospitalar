...
% DADOS DO DOCUMENTO
% -------------------------------------------------
\newcommand{\logoarquivo}{logo_catolica.png}
...
% COMANDOS AUXILIARES
% -------------------------------------------------
\newcommand{\rf}[2]{#1 & #2 \\\midrule}
\newcommand{\rnf}[2]{#1 & #2 \\\midrule}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{GTPlan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{bionexo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Slimstock.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{o9solutions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Usuario hospitalar (CDU).png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Administrador login e importar dados (CDU).png}
...
\rf{RF02} {O sistema deve permitir a importação de bases históricas de consumo hospitalares em formato CSV ou Excel.}
...
\rf{RF05} {O sistema deve permitir a classificação dos itens conforme padrões de consumo definidos no projeto, como as classficações ABC e a classificação combinada ABC.}
...
\rnf{RNF02}	{O sistema deve gerar previsões para um conjunto padrão de até 1.000 itens em no máximo 60 segundos.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{Atividades_usuario.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{atividades_administrador.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{TCC-fluxo_navegacao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Dasdboard.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Importar Dados.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Previsões.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Exportar Relatórios.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Gestão de Usuários.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Gestao_Hospitais.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Solicitacao_Acesso.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{C4_Contexto.png}
...
(FastAPI) via HTTPS. A API orquestra o Serviço de ML (Scikit-learn/Statsmodels)
e persiste os dados no banco PostgreSQL via SQLAlchemy.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{C4_Containers.png}
...
container do sistema. São sete módulos com responsabilidades distintas:
Autenticação, Gestão de Usuários, Importação, Validação e Tratamento,
Previsão, Dashboard e Exportação de Relatórios.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.10\textwidth]{C4_Componentes.png}
...
10 tabelas. Todas as tabelas de dados operacionais possuem o campo
\texttt{empresa\_id} para garantir o isolamento completo entre as
empresas cadastradas na plataforma.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.10\textwidth]{TCC-DER.png}
...
dos modelos (Scikit-learn e Statsmodels), avaliação por métricas (RMSE, 
...
\begin{itemize}
    ...
    \item \textbf{NumPy:} Utilizado como base para operações numéricas e suporte às bibliotecas de análise de dados e Machine Learning.
    \item \textbf{Scikit-learn:} Biblioteca empregada na implementação de modelos de Machine Learning e cálculo de métricas de desempenho como RMSE, MAE e MAPE.
    \item \textbf{Statsmodels:} Utilizada para aplicação de modelos de séries temporais, como ARIMA e Holt-Winters, voltados à previsão de consumo.
\end{itemize}
...
\midrule
M1 & Finalização da documentação RFC, contemplando levantamento de requisitos, arquitetura, mockups e planejamento do projeto. & 30/04/2026 \\
\midrule
M2 & Desenvolvimento do back-end, contemplando API REST, pipeline de importação e validação de dados, e camada de persistência & 15/06/2026 \\
\midrule
M3 & Desenvolvimento do front-end da aplicação, incluindo todas as telas definidas nos mockups e integração com a API. & 05/08/2026 \\
\midrule
M4 & Desenvolvimento e avaliação do modelo preditivo, incluindo pipeline de Machine Learning, treinamento e métricas de desempenho. & 30/10/2026 \\
\midrule
M5 & Integração dos módulos, testes finais do sistema e entrega da versão completa do projeto. & 30/11/2026 \\
\bottomrule
\end{tabular}
\end{center}
